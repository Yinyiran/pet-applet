// ============ 同城数据 ============
const cityData = [
  { cat:'shop', icon:'🛒', cls:'shop', name:'宠乐多生活馆', tags:['4.9分','店铺'], desc:'进口主粮、零食、玩具一站式采购，会员享95折', addr:'余杭区文一西路998号', tel:'0571-88886661' },
  { cat:'shop', icon:'🐾', cls:'shop', name:'爪爪宠物便利店', tags:['4.7分','店铺'], desc:'社区宠物便利店，主营主粮零食及基础用品', addr:'西湖区古墩路388号', tel:'0571-88886662' },
  { cat:'hospital', icon:'💉', cls:'hospital', name:'瑞鹏宠物医院(城西院)', tags:['4.8分','医院'], desc:'24小时急诊，配备DR、彩超、生化分析仪等设备', addr:'拱墅区莫干山路688号', tel:'0571-88886663' },
  { cat:'hospital', icon:'🩺', cls:'hospital', name:'芭比堂动物医院', tags:['4.9分','医院'], desc:'专科诊疗：骨科、眼科、牙科，拥有多名执业兽医师', addr:'上城区望江东路168号', tel:'0571-88886664' },
  { cat:'beauty', icon:'🛁', cls:'beauty', name:'萌宠造型美容工作室', tags:['4.8分','美容'], desc:'韩国宠物美容师驻店，提供造型、SPA、药浴服务', addr:'余杭区荆长路58号', tel:'0571-88886665' },
  { cat:'beauty', icon:'✂️', cls:'beauty', name:'小爪爪宠物美容', tags:['4.6分','美容'], desc:'专业洗护造型，使用进口洗护产品，宠物友好环境', addr:'西湖区紫荆花路22号', tel:'0571-88886666' },
  { cat:'park', icon:'🌲', cls:'park', name:'汪汪宠物乐园', tags:['4.7分','乐园'], desc:'占地3000㎡，设有敏捷赛道、游泳池、草坪活动区和宠物咖啡', addr:'余杭区径山镇双溪路1号', tel:'0571-88886667' },
  { cat:'park', icon:'🏕️', cls:'park', name:'毛小孩户外营地', tags:['4.8分','乐园'], desc:'宠物露营地，可烧烤、徒步、宠物摄影，周末亲子好去处', addr:'临安区青山湖街道8号', tel:'0571-88886668' },
  { cat:'party', icon:'🎂', cls:'party', name:'宠爱一生宠友会', tags:['4.6分','聚会'], desc:'每月主题聚会：宠物生日趴、品种交流会、领养日活动', addr:'西湖区天目山路208号', tel:'0571-88886669' },
  { cat:'party', icon:'🐶', cls:'party', name:'哈士奇俱乐部', tags:['4.8分','聚会'], desc:'二哈专属社群，定期组织线下遛狗、游泳、拆家大赛', addr:'余杭区五常大道77号', tel:'0571-88886670' }
];
    ...
    <div class="city-card" onclick="openCityDetail(${cityData.indexOf(d)})">
      ...
      <div class="city-card-info">
        ...
        <div class="city-card-tags">
          ...
          <span class="city-card-tel" onclick="event.stopPropagation(); copyTel('${d.tel}')" title="点击复制电话">
        ...
        <div class="city-card-addr">
          ...
          <span class="city-card-nav" onclick="event.stopPropagation(); navigateTo(${cityData.indexOf(d)})" title="导航">
