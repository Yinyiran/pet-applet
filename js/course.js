...
const courseDetails = {
  basic: {
    icon: '📱', tag: '入门首选', tagBg: '#bbdefb', tagColor: '#1565c0', heroBg: 'linear-gradient(135deg, #e3f2fd, #bbdefb)',
    name: '线上录播课', price: '¥399', btnClass: 'basic-btn',
    desc: '适合零基础想了解宠物赛道的新手，32节系统录播课程覆盖从选品到成交的全流程。',
    items: ['32节高清录播课，终身回看', '宠物零食/用品选品方法论', '短视频获客实操技巧', '私域流量搭建与转化', '社群答疑 + 每周直播答疑', '赠送全套供应商名录'],
    videos: [
  ...
  pro: {
    icon: '👨‍🏫', tag: '🔥 热门推荐', tagBg: '#f8bbd0', tagColor: '#ad1457', heroBg: 'linear-gradient(135deg, #fce4ec, #f8bbd0)',
    name: '达人陪跑营', price: '¥2,999', btnClass: 'pro-btn',
    desc: '90天1v1深度陪跑，从账号搭建到稳定出单，导师手把手带你跑通宠物轻创全链路。',
    items: ['包含全部录播课内容', '90天导师1v1专属指导', '账号定位与人设打造方案', '每周实战作业批改反馈', '优质货源厂家直接对接', '抖音/小红书流量扶持计划', '优秀学员可获平台签约机会'],
    videos: [
      ...
      { id:3, free:false, title:'进阶课4：达人IP打造全流程', dur:'26:00', thumb:'🌟' },
      { id:4, free:false, title:'进阶课5：多平台矩阵运营策略', dur:'24:15', thumb:'🔗' },
      { id:5, free:false, title:'进阶课6：月销10万案例深度复盘', dur:'30:00', thumb:'🏆' }
    ]
  },
  partner: {
    icon: '💎', tag: '👑 高阶权益', tagBg: '#e1bee7', tagColor: '#7b1fa2', heroBg: 'linear-gradient(135deg, #f3e5f5, #e1bee7)',
    name: '合伙人陪跑', price: '¥5,999', btnClass: 'partner-btn',
    desc: '全年深度陪跑 + 区域代理权 + 分红权益，打造属于你自己的宠物轻创事业。',
    items: ['包含达人陪跑营全部权益', '全年365天深度陪跑', '所在城市独家区域代理权', '团队搭建与管理培训', '平台佣金分红权益', '线下私董会（每季度1次）', '可参与平台项目投资决策'],
    videos: [
...
function openCourseDetail(type) {
  ...
  document.getElementById('courseDetailList').innerHTML = d.items.map(i =>
